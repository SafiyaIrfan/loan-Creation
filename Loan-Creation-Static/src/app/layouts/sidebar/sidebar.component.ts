...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, SimplebarAngularModule, NgFor, NgIf, NgClass, TranslateModule]
})
export class SidebarComponent implements OnInit {
  ...
  //Navigation to dashboard on clicking Logo
  navigateToDashboard(){
    const currentRoute = this.router.url;
    if (currentRoute == "./home/dashboard") {    // User is already on the dashboard, do nothing
      return;

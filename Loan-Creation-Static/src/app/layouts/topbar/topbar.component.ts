...
import { DOCUMENT, NgIf, NgFor, NgClass, DatePipe } from '@angular/common';
...
import { NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavContent, NgbNavOutlet } from '@ng-bootstrap/ng-bootstrap';
...
@Component({
  ...
  standalone: true,
  imports: [SimplebarAngularModule, NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, NgIf, NgFor, NgClass, RouterLink, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavContent, NgbNavOutlet, MaterialModule]
})
export class TopbarComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) private document: any, private eventService: EventService, public languageService: LanguageService, public dialog: MatDialog,
  ...
  theme() {
    this._route.navigate(['/settings/theme'])
  }
  ...
  */
  ...
  openCalculator() {
    const dialogRef = this.dialog.open(TabContainerComponent, {
      width: '400px',
      height: '100vh',
      position: { right: '0' }, panelClass: ['animate__animated', 'animate__fadeInRight']
    });
